...
$result = $link->query( "SELECT * FROM possedeequipe" ) or die("SELECT Error: ".$link->error);
...
?>
<br>
<form method="POST" action="equipes_delete_record.php">
<input type="hidden" name="username" value="<?php print $_POST['username']?>">
<input type="hidden" name="password" value="<?php print $_POST['password']?>">
<pre>
Entrer du dresseur de l'équipe a effacer: <input type="text" name="NomDresseur" size="5">
