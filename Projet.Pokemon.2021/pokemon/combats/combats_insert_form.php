...
<form method="POST" action="combats_test_combat.php">
...
<tr><td>Pokémon adverse :</td><td>
<select name="NomPokemonB" id="nPokemonB" class="reginput"/>
<option value="">Choisissez un Pokemon</option>
<?php $s="SELECT NomPokemon FROM pokemons;";
$q=$link->query($s) or die($s);
while($row=$q->fetch_array(MYSQLI_ASSOC))
