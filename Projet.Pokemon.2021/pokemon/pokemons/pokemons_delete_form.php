<html><head><title>Pokémons </title><link rel="stylesheet" href="../styles.css"></head>
<body>
<?php
$db="pokemon2019";
...
print "Il y a $num_rows pokémons enregistré.<p>";
...
<pre>
Entrer le numero du pokémon à effacer: <input type="text" name="Numero" size="5">
